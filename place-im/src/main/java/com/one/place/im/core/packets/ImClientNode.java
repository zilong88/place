...
public class ImClientNode extends Message{
  ...
  private static final long serialVersionUID = -5482681065267071825L;
  /**
   * 客户端ip
   */
  private String ip;
  ...
  private ImClientNode(String id, String ip, int port, ImUser user, String region, String useragent){
    this.id = id;
    this.ip = ip;
    this.port = port;
    this.user = user;
  ...
  public static class Builder extends Message.Builder<ImClientNode,ImClientNode.Builder> {
    ...
    public ImClientNode.Builder user(ImUser user) {
      this.user = user;
      return this;
    }
