...
public class ChatBody extends Message {
  ...
  private static final long serialVersionUID = 4473953489575887801L;
  ...
  private ChatBody(String id, String from, String to, Integer msgType, Integer chatType,
      String content, String groupId, Integer cmd, Long createTime, Map<String, Object> extras) {
    this.id = id;
    this.from = from;
    this.to = to;
  ...
  public static class Builder extends Message.Builder<ChatBody, ChatBody.Builder> {
    ...
    public ChatBody build() {
      return new ChatBody(this.id, this.from, this.to, this.msgType, this.chatType, this.content,
          this.groupId, this.cmd, this.createTime, this.extras);
    }
  }
}
