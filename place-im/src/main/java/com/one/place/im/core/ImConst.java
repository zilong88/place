...
public interface ImConst {
  interface Key{
     ...
     * 存放HttpConfig
     */
    String HTTP_SERVER_CONFIG = "IM_HTTP_SERVER_CONFIG";
  }

  interface Topic{
    String REDIS_CLUSTER_TOPIC_SUFFIX = "REDIS_";
    String JIM_CLUSTER_TOPIC = "IM_CLUSTER";
  }
  ...
  interface Protocol{
    ...
    String COOKIE_NAME_FOR_SESSION = "im-s";
    /**
     * 消息体最多为多少,只支持多少M数据
     */
  ...
  interface Http {
    ...
    /**
     * Accept-Language : zh-CN,zh;q=0.8 Sec-WebSocket-Version : 13 Sec-WebSocket-Extensions :
     * permessage-deflate; client_max_window_bits Upgrade : websocket Host : t-io.org:9321
     * Accept-Encoding : gzip, deflate, sdch User-Agent : Mozilla/5.0 (Windows NT 6.1; Win64; x64)
     * AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 Origin :
     * http://www.t-io.org:9292 Sec-WebSocket-Key : kmCL2C7q9vtNSMyHpft7lw== Connection : Upgrade
