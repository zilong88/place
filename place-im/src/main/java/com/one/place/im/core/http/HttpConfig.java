...
import com.one.place.im.core.session.SessionIdGenerator;
...
public class HttpConfig implements ImConst {
  ...
  public HttpConfig(HttpRequestHandler httpRequestHandler, HttpServerListener httpServerListener){
  ...
  public static class Builder{
    ...
    public Builder sessionIdGenerator(SessionIdGenerator sessionIdGenerator){
    ...
    public Builder httpServerListener(HttpServerListener httpServerListener){
  ...
  public HttpServerListener getHttpServerListener() {
    return httpServerListener;
  }

  public void setHttpServerListener(HttpServerListener httpServerListener) {
    this.httpServerListener = httpServerListener;
  }
